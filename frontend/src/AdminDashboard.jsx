...
export default function AdminDashboard() { 
  ...
  /* New State for Admin-to-Admin Creation */
    ...
    <div className="portal-container"> 
      ...
      <main className="portal-main"> 
        ...
        <section className="info-card"> 
          ...
          <div className="info-row"> 
            <span>Vacant & Ready:</span> <span style={{color: '#059669', fontWeight: 'bold'}}>3</span> 
          </div> 
          <div className="info-row"> 
            <span>Pending Lease:</span> <span style={{color: 'var(--primary)', fontWeight: 'bold'}}>5</span> 
          </div> 
        </section> 
        ...
        <section className="info-card"> 
          ...
          <button className="btn pay-btn" style={{width: '100%'}} onClick={handleReviewAll}> Review All Applications </button> 
        </section> 
      </main> 
      ...
      <section className="info-card">
        ...
        <p style={{fontSize: '0.8rem', color: '#666', marginBottom: '10px'}}>Authorized: Add a new property manager account.</p>
        <div style={{display: 'flex', gap: '10px', marginBottom: '10px'}}>
            <input type="email" placeholder="New Admin Email" value={newAdminEmail} onChange={(e)=>setNewAdminEmail(e.target.value)} 
            style={{flex: 1, padding: '12px', borderRadius: '8px', border: '1px solid #ddd'}} />
            <input type="password" placeholder="Temp Password" value={newAdminPass} onChange={(e)=>setNewAdminPass(e.target.value)} 
            style={{flex: 1, padding: '12px', borderRadius: '8px', border: '1px solid #ddd'}} />
        </div>
      ...
      <section className="info-card"> 
        ...
        <textarea value={announcement} onChange={(e) => setAnnouncement(e.target.value)} placeholder="Enter message for all residents..." 
        style={{width: '100%', minHeight: '100px', padding: '12px', borderRadius: '8px', border: '1px solid #ddd', marginBottom: '10px'}} /> 
        <button className="btn maintenance-btn" style={{width: '100%'}} onClick={handlePostAnnouncement}> Post Announcement </button> 
      </section> 
    </div> 
  ); 
}